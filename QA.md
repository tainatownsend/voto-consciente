...
- Fixed autoplay background-tab behavior: if the page becomes hidden while autoplay is running, playback pauses instead of silently advancing while the user is away.
